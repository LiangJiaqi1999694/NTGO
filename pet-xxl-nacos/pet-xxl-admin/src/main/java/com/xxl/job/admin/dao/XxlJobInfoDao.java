...
public interface XxlJobInfoDao {
    ...
    public List<XxlJobInfo> pageList(@Param("offset") int offset, @Param("pagesize") int pagesize,
                                     ...
                                     @Param("jobDesc") String jobDesc,@Param("jobType") Integer jobType,@Param("categoryId") Long categoryId);
    ...
    public int deleteByExecutorHandlers(@Param("jobGroup") int jobGroup, @Param("executorHandlers") Set<String> executorHandlers);

    public List<XxlJobInfo> loadByAlgoId(@Param("algoId") long algoId);
}
